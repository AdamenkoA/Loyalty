...
public class Topic  {
    ...
    public Topic(final RecyclerView recyclerView, final TopicFragment.OnListFragmentInteractionListener mListener) {
        AsyncHttpClient client = new AsyncHttpClient();
        HashMap<String, String> param = new HashMap<String, String>();
        param.put("app", "AIzaSyB2zA4TL9napLFnR0cNI_I9gcdfg9qmZ6g");
        RequestParams params = new RequestParams(param);
        client.get("http://safe-forest-50436.herokuapp.com/api/topics", params, new AsyncHttpResponseHandler() {
                @Override
