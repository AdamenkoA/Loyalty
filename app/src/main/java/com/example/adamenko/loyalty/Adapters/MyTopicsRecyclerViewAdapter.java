...
public class MyTopicsRecyclerViewAdapter extends RecyclerView.Adapter<MyTopicsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTopicsRecyclerViewAdapter(List<DummyContent.DummyItem> items, TopicsFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_topics_list, parent, false);
