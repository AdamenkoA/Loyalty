package com.example.adamenko.loyalty.Crypter;
...
/**
 * Created by Adamenko on 12.08.2016.
 */
...
public class StringCrypter {
    ...
    public String encrypt(String str) {
        try {
            ...
            return new String(Base64.encode(enc,16));
